...
public class CalenderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CalenderAdapter(Calendar calendar ){
        mCalendar = calendar;
    ...
    public CalenderAdapter(SelfDate selfDate){
        ...
        if(holder1 instanceof CalenderViewHolder) {
            ...
            switch (position){
                ...
                case 6:
                    ...
                    break;
                default:
                    if(position <= mExtraDay + 6 ){
                        holder.tv_cal.setText("");
                    }else{
                        holder.tv_cal.setText((position- mExtraDay - 6) + "");
                    }
                    break;
            }
