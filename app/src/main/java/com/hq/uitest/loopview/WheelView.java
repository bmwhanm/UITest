...
//        coverPaint.setShader(shader);
//        coverPaint.setColorFilter(null);

//        coverPaint.setColorFilter(new ColorMatrixColorFilter(new float[]{
//                1f, 0, 0, 0, 0,
//                0, 1f, 0, 0, 0,
//                0, 0, 1f, 0, 0,
//                0, 0, 0, 1f, 0
...
//                0, 0, 0, 1f, 0
//        }));
//        canvas.drawRect(0, centerItemTop,getMeasuredWidth(), centerItemBottom, coverPaint);
//        canvas.save();
//        canvas.rotate(360);
//        canvas.drawRect(0, centerItemTop,getMeasuredWidth(), centerItemBottom, coverPaint);
//        canvas.restore();
