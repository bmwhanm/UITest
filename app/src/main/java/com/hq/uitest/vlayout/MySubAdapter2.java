...
public class MySubAdapter2 extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    private LayoutHelper mLayoutHelper;
    private Context mContext;

    public MySubAdapter2(Context context, LayoutHelper layoutHelper){
        mContext = context;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof ItemViewHolder){
            ...
            h.itemView.setBackgroundColor(Color.BLUE);
